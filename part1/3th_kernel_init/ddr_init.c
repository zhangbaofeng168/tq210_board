...
void copy_code_to_dram()
{
	volatile unsigned long *Si_code = (volatile unsigned long *)0xd0020010;
	volatile unsigned long *Ar_code = (volatile unsigned long *)0x20000000;
	int i=0;
	for(;i<4096;i++)
	{
		*Ar_code = *Si_code;
